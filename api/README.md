...
This is the backend API for HackDeepWiki, providing smart code analysis and AI-powered documentation generation.
...
HackDeepWiki supports multiple LLM providers. The environment variables above are required depending on which providers you want to use:
...
##### Configuration Files
HackDeepWiki now uses JSON configuration files to manage various system components instead of hardcoded values:
...
# Request data
payload = {
    "repo_url": "https://github.com/kroryan/hackdeepwiki",
    "messages": [
        {
            "role": "user",
